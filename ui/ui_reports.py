...
class ReportsUI(QWidget):
    ...
    def setup_ui(self):
        ...
        # Title
        self.title_label = QLabel("📊 Financial Reports & AI Analysis")
        ...
        # ===== NEW: Tab Widget for Statistical Report vs AI Report =====
        self.tab_widget = QTabWidget()
        self.tab_widget.setObjectName("reports_tabs")
        
        # Tab 1: Statistical Report (existing)
        self.stats_tab = QWidget()
        self.setup_stats_tab()
        self.tab_widget.addTab(self.stats_tab, "📊 Statistical Report")
        
        # Tab 2: AI Analysis Report (NEW)
        self.ai_tab = QWidget()
        self.setup_ai_tab()
        ...
        # Export buttons (shared for both tabs)
        export_frame = QFrame()
    ...
    def setup_stats_tab(self):
        """Setup the statistical report tab (existing functionality)"""
        ...
        # Set layout for stats tab
        stats_tab_layout = QVBoxLayout(self.stats_tab)
        stats_tab_layout.setContentsMargins(0, 0, 0, 0)
        stats_tab_layout.addWidget(scroll_area)

    def setup_ai_tab(self):
        """Setup the AI analysis report tab (NEW)"""
        ...
        ai_title = QLabel("🤖 AI-Powered Stock Analysis")
        ai_title_font = QFont()
        ai_title_font.setPointSize(16)
        ai_title_font.setBold(True)
        ai_title.setFont(ai_title_font)
        
        self.generate_ai_report_btn = QPushButton("⚡ Generate AI Report")
        self.generate_ai_report_btn.setObjectName("generate_ai_report_btn")
        self.generate_ai_report_btn.setFixedHeight(40)
        self.generate_ai_report_btn.setFixedWidth(200)
        self.generate_ai_report_btn.setCursor(Qt.PointingHandCursor)
        
        header_layout.addWidget(ai_title)
        header_layout.addStretch()
        header_layout.addWidget(self.generate_ai_report_btn)
        
        ai_layout.addLayout(header_layout)
        
        # Progress/Status label for AI generation
        self.ai_status_label = QLabel("💡 Click 'Generate AI Report' to get comprehensive AI-powered analysis")
        self.ai_status_label.setAlignment(Qt.AlignCenter)
        self.ai_status_label.setObjectName("ai_status_label")
        self.ai_status_label.setFixedHeight(35)
        self.ai_status_label.setWordWrap(True)
        ai_layout.addWidget(self.ai_status_label)
        
        # AI Report display area with scroll
        scroll_area = QScrollArea()
        scroll_area.setWidgetResizable(True)
        scroll_area.setObjectName("ai_scroll_area")
        
        scroll_widget = QWidget()
        scroll_layout = QVBoxLayout(scroll_widget)
        
        self.ai_report_text = QTextEdit()
        self.ai_report_text.setObjectName("ai_report_text")
        self.ai_report_text.setReadOnly(True)
        self.ai_report_text.setMinimumHeight(600)
...
### 📋 How to use:
1. Load stock data from the dashboard (search for a ticker like AAPL, TSLA, MSFT)
2. Navigate to Reports page
3. Wait for statistical report and forecast to generate
4. Switch to this **AI Analysis** tab
5. Click **"Generate AI Report"** button above

---

### 🎯 What you'll get:
- **Executive Summary** - Quick overview of stock performance
- **Price Performance Analysis** - Detailed trend analysis
- **Technical Analysis** - Interpretation of indicators (SMA, RSI, MACD, etc.)
- **Volume Analysis** - Trading activity insights
- **ML Forecast Interpretation** - AI prediction explanation
- **Risk Assessment** - Investment risk evaluation
- **Clear Recommendation** - BUY, HOLD, or SELL with reasoning
...
*Powered by Groq AI (Llama 3.3 70B)*
        ...
        self.ai_report_text.setMarkdown(placeholder_text)
        
        scroll_layout.addWidget(self.ai_report_text)
        scroll_area.setWidget(scroll_widget)
        
        ai_layout.addWidget(scroll_area, 1)

    # ===== Progress & Loading Methods =====
    ...
    def show_error(self, error_msg):
        """Display error message in statistical tab"""
        self.summary_text.append(f"\n\n❌ {error_msg}")
    
    # ===== AI Report Methods (NEW) =====
    
    def set_ai_report(self, report_text):
        """Display AI-generated report (NEW)"""
        self.ai_report_text.setMarkdown(report_text)
        self.ai_status_label.setText("✅ AI Report generated successfully!")
        print("✅ AI report displayed in UI")
    ...
    def show_ai_error(self, error_msg):
        ...
        self.ai_status_label.setText(f"❌ {error_msg}")
        error_markdown = f"""
...
### 💡 Tips:
- Make sure stock data is loaded first
- Wait for statistical forecast to complete
- Check the console for detailed error messages
        """
        self.ai_report_text.setMarkdown(error_markdown)
